#!/bin/bash
DATASET=../../mat_graphs
RESULTS_DIR=../../graphlet_lsk_results
...
do
    ...
    #./run_kernel -p ${DATASET}/${id}.pos -n ${DATASET}/${id}.neg -g ${GRAPH_FILE} -l ${LABELS_FILE} -t 2 -s ${RESULTS_DIR}/${id}_sgk.svml -N true -v

    #./run_kernel -p ${DATASET}/${id}.pos -n ${DATASET}/${id}.neg -g ${GRAPH_FILE} -l ${LABELS_FILE} -t 4 -E 1 -s ${RESULTS_DIR}/${id}_edk.svml -N true -v

    ./run_kernel -p ${DATASET}/${id}.pos -n ${DATASET}/${id}.neg -g ${GRAPH_FILE} -l ${LABELS_FILE} -t 3 -M 0.26 -A ACDEFGHIKLMNPQRSTVWY -s ${RESULTS_DIR}/${id}_lsk.svml -N true -v
